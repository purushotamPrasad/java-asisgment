...
* The original package name 'com.qssence.backend.document-initiation-service' is invalid and this project uses 'com.qssence.backend.document_initiation_service' instead.
...
* [Spring for Apache Kafka](https://docs.spring.io/spring-boot/docs/3.2.11-SNAPSHOT/reference/htmlsingle/index.html#messaging.kafka)
